...
O **[!UICONTROL Desempenho da Organização]** relata a atividade de saída e os resultados na equipe. Ela tem três guias: **[!UICONTROL Visão geral]**, **[!UICONTROL Emails]** e **[!UICONTROL Tarefas]**.
...
* Tabela de **[!UICONTROL Atividade da Equipe]**: atividade dividida por representante.

### Guia Emails

A guia **[!UICONTROL Emails]** informa sobre o volume e a eficácia do email:

* **Blocos**: Emails enviados, abertos, clicados e respondidos.
...
* Tabela **[!UICONTROL Campanhas]**: email, reunião, chamada e atividade de mensagem do LinkedIn para cada campanha. Expanda uma linha de campanha para ver detalhes de nível representativo dessa campanha.
