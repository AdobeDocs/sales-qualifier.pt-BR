---
title: Clientes potenciais no qualificador Adobe Marketo
description: Saiba como criar sua lista de clientes potenciais a partir do CRM, de fontes importadas e adicionadas manualmente, filtrar clientes potenciais e revisar detalhes do cliente potencial no Adobe Marketo Qualifier.
...
* **[!UICONTROL Destaques de Marketing]**—Clientes potenciais com atividade de Marketo ao vivo, como aberturas ou cliques de email.
...
* **Prospetos do CRM** — O Adobe Marketo Qualifier importa automaticamente clientes potenciais e contatos atribuídos ao usuário conectado. Consulte [Integrações](integrations.md).
...
1. Na página **[!UICONTROL Clientes potenciais]**, selecione **[!UICONTROL Lista de pessoas]**.
   ...
   ![Lista de pessoas](assets/prospects-people-list.png){width="800" zoomable="yes"}
...
1. Selecione **[!UICONTROL + Adicionar pessoas]** e **[!UICONTROL Importar CSV]** ou **[!UICONTROL Adicionar pessoa]**.
   ...
   * Para uma importação de CSV, carregue um CSV no formato `firstname,email`.
     ...
     Mapeie campos CSV personalizados ou adicionais, não apenas os campos padrão. O Qualificador Marketo salva esses valores em cada cliente potencial e os disponibiliza posteriormente, inclusive para [geração de email](outbound-workflows.md#step-5-add-prospects-and-start-email-generation).
...
Os destaques de marketing estão disponíveis em todas as regiões de produção. Um administrador conclui uma configuração única que conecta o [!DNL Marketo] ao Qualificador do Marketo. Consulte [Configurar destaques de marketing](integrations.md#turn-on-marketo-engagement-filtering).
